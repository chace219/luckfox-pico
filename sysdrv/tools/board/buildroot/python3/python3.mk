...
PYTHON3_VERSION = $(PYTHON3_VERSION_MAJOR).16
...
define PYTHON3_REMOVE_USELESS_FILES
	...
	# Stock buildroot 2023.02.6 removes 'smtpd.py.3' here, but CPython installs this
	# as smtpd.py.$(minor) — smtpd.py.11 for 3.11 — so the rm has been a silent no-op
	# and the stdlib's demo SMTP *server* (31 KB, executable) shipped on the device's
	# PATH in every image. Globbed so it stays fixed across minor versions.
