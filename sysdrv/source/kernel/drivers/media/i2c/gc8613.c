...
static __maybe_unused const u32 reg_val_table_hdr[26][7] = {
 ...
 * release_liner_v2.2.1_06_2lane_raw10_3840x2160_30fps_24mhz_GC8613YA_AOV.txt
 */
static const struct regval gc8613_linear_10bit_3840x2160_30fps_regs[] = {
	{0x03fe, 0xf0},
	{0x03fe, 0x00},
	{0x03fe, 0x10},
	{0x0a38, 0x01},
...
//static const struct regval gc8613_linear_global_regs[] = {
//	{0x0080, 0x02},
//	{0x0097, 0x0a},
//	{0x0098, 0x10},
//	{0x0099, 0x05},
 ...
 *
 */
static const struct regval gc8613_linear_10bit_3840x2160_25fps_regs[] = {
	{ 0x03fe, 0xf0 },
	{ 0x03fe, 0x00 },
	{ 0x03fe, 0x10 },
	{ 0x0a38, 0x01 },
 ...
 *
 */
static const struct regval gc8613_linear_10bit_3840x2160_15fps_regs[] = {
	{0x03fe, 0xf0},
	{0x03fe, 0x00},
	{0x03fe, 0x10},
	{0x0a38, 0x01},
 ...
 *
 */
static const struct regval gc8613_linear_10bit_3840x2160_20fps_regs[] = {
	{0x03fe, 0xf0},
	{0x03fe, 0x00},
	{0x03fe, 0x10},
	{0x0a38, 0x01},
			    ...
			    struct preisp_hdrae_exp_s *ae)
{
	...
	if (s_exp_time > gc8613->cur_vts - 1492) {
		dev_err(&gc8613->client->dev, "the s_exp_time is too large.\n");
		s_exp_time = gc8613->cur_vts - 1492;
	}

	if (l_exp_time > gc8613->cur_vts - s_exp_time) {
		dev_err(&gc8613->client->dev, "the l_exp_time is too large.\n");
...
static int gc8613_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_VBLANK:
		...
		max = gc8613->cur_mode->height + ctrl->val - 4;
				  ...
				  struct i2c_client *client)
{
	...
	dev_info(dev, "Detected gc8613 (0x%04x) sensor\n", id);
	return 0;
}
