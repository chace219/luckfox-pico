...
#define ISP33_SLICE_ST_CTRL			(ISP3X_ISP_BASE + 0x002a4)
#define ISP33_AIISP_LINE_CNT			(ISP3X_ISP_BASE + 0x002a8)
...
#define ISP33_MAIN_SCALE_BASE			0x00000c00
#define ISP33_MAIN_SCALE_CTRL			(ISP33_MAIN_SCALE_BASE + 0x0000)
#define ISP33_MAIN_SCALE_UPDATE			(ISP33_MAIN_SCALE_BASE + 0x0004)
#define ISP33_MAIN_SCALE_SRC_SIZE		(ISP33_MAIN_SCALE_BASE + 0x0008)
#define ISP33_MAIN_SCALE_DST_SIZE		(ISP33_MAIN_SCALE_BASE + 0x000c)
#define ISP33_MAIN_SCALE_HY_FAC			(ISP33_MAIN_SCALE_BASE + 0x0010)
#define ISP33_MAIN_SCALE_HC_FAC			(ISP33_MAIN_SCALE_BASE + 0x0014)
#define ISP33_MAIN_SCALE_VY_FAC			(ISP33_MAIN_SCALE_BASE + 0x0018)
#define ISP33_MAIN_SCALE_VC_FAC			(ISP33_MAIN_SCALE_BASE + 0x001c)
#define ISP33_MAIN_SCALE_HY_OFFS		(ISP33_MAIN_SCALE_BASE + 0x0020)
#define ISP33_MAIN_SCALE_HC_OFFS		(ISP33_MAIN_SCALE_BASE + 0x0024)
#define ISP33_MAIN_SCALE_VY_OFFS		(ISP33_MAIN_SCALE_BASE + 0x0028)
#define ISP33_MAIN_SCALE_VC_OFFS		(ISP33_MAIN_SCALE_BASE + 0x002c)
#define ISP33_MAIN_SCALE_HY_SIZE		(ISP33_MAIN_SCALE_BASE + 0x0040)
#define ISP33_MAIN_SCALE_HC_SIZE		(ISP33_MAIN_SCALE_BASE + 0x0044)
#define ISP33_MAIN_SCALE_HY_OFFS_MI		(ISP33_MAIN_SCALE_BASE + 0x0048)
#define ISP33_MAIN_SCALE_HC_OFFS_MI		(ISP33_MAIN_SCALE_BASE + 0x004c)
#define ISP33_MAIN_SCALE_IN_CROP_OFFSET		(ISP33_MAIN_SCALE_BASE + 0x0050)
#define ISP33_MAIN_SCALE_CTRL_SHD		(ISP33_MAIN_SCALE_BASE + 0x0080)
#define ISP33_MAIN_SCALE_SRC_SIZE_SHD		(ISP33_MAIN_SCALE_BASE + 0x0088)
#define ISP33_MAIN_SCALE_DST_SIZE_SHD		(ISP33_MAIN_SCALE_BASE + 0x008c)
#define ISP33_MAIN_SCALE_HY_FAC_SHD		(ISP33_MAIN_SCALE_BASE + 0x0090)
#define ISP33_MAIN_SCALE_HC_FAC_SHD		(ISP33_MAIN_SCALE_BASE + 0x0094)
#define ISP33_MAIN_SCALE_VY_FAC_SHD		(ISP33_MAIN_SCALE_BASE + 0x0098)
#define ISP33_MAIN_SCALE_VC_FAC_SHD		(ISP33_MAIN_SCALE_BASE + 0x009c)
#define ISP33_MAIN_SCALE_HY_OFFS_SHD		(ISP33_MAIN_SCALE_BASE + 0x00a0)
#define ISP33_MAIN_SCALE_HC_OFFS_SHD		(ISP33_MAIN_SCALE_BASE + 0x00a4)
#define ISP33_MAIN_SCALE_VY_OFFS_SHD		(ISP33_MAIN_SCALE_BASE + 0x00a8)
#define ISP33_MAIN_SCALE_VC_OFFS_SHD		(ISP33_MAIN_SCALE_BASE + 0x00ac)
#define ISP33_MAIN_SCALE_HY_SIZE_SHD		(ISP33_MAIN_SCALE_BASE + 0x00c0)
#define ISP33_MAIN_SCALE_HC_SIZE_SHD		(ISP33_MAIN_SCALE_BASE + 0x00c4)
#define ISP33_MAIN_SCALE_HY_OFFS_MI_SHD		(ISP33_MAIN_SCALE_BASE + 0x00c8)
#define ISP33_MAIN_SCALE_HC_OFFS_MI_SHD		(ISP33_MAIN_SCALE_BASE + 0x00cc)
#define ISP33_MAIN_SCALE_IN_CROP_OFFSET_SHD	(ISP33_MAIN_SCALE_BASE + 0x00d0)
...
#define ISP33_AIISP_RD_BASE			(ISP3X_MI_BASE + 0x00570)
...
#define ISP33_DEBAYER_LUMA_DX			(ISP3X_DEBAYER_BASE + 0x00004)
#define ISP33_DEBAYER_G_INTERP			(ISP3X_DEBAYER_BASE + 0x00010)
#define ISP33_DEBAYER_G_INTERP_FILTER1		(ISP3X_DEBAYER_BASE + 0x00014)
#define ISP33_DEBAYER_G_INTERP_FILTER2		(ISP3X_DEBAYER_BASE + 0x00018)
#define ISP33_DEBAYER_G_INTERP_OFFSET_ALPHA	(ISP3X_DEBAYER_BASE + 0x0001c)
#define ISP33_DEBAYER_G_INTERP_DRCT_OFFSET0	(ISP3X_DEBAYER_BASE + 0x00020)
#define ISP33_DEBAYER_G_FILTER_MODE_OFFSET	(ISP3X_DEBAYER_BASE + 0x00050)
#define ISP33_DEBAYER_G_FILTER_FILTER		(ISP3X_DEBAYER_BASE + 0x00054)
#define ISP33_DEBAYER_G_FILTER_VSIGMA0		(ISP3X_DEBAYER_BASE + 0x00058)
#define ISP33_DEBAYER_G_FILTER_VSIGMA1		(ISP3X_DEBAYER_BASE + 0x0005c)
#define ISP33_DEBAYER_G_FILTER_VSIGMA2		(ISP3X_DEBAYER_BASE + 0x00060)
#define ISP33_DEBAYER_G_FILTER_VSIGMA3		(ISP3X_DEBAYER_BASE + 0x00064)
...
#define ISP33_CNR_WGT_SIGMA0			(ISP3X_CNR_BASE + 0x00044)
#define ISP33_CNR_WGT_SIGMA3			(ISP3X_CNR_BASE + 0x00050)
#define ISP33_CNR_GAUS_X_SIGMAR0		(ISP3X_CNR_BASE + 0x00054)
#define ISP33_CNR_GAUS_X_SIGMAR2		(ISP3X_CNR_BASE + 0x0005c)
#define ISP33_CNR_GAUS_Y_SIGMAR0		(ISP3X_CNR_BASE + 0x00060)
...
#define ISP33_DRC_BILAT0			(ISP3X_DRC_BASE + 0x0000c)
#define ISP33_DRC_BILAT1			(ISP3X_DRC_BASE + 0x00010)
#define ISP33_DRC_BILAT2			(ISP3X_DRC_BASE + 0x00014)
#define ISP33_DRC_BILAT3			(ISP3X_DRC_BASE + 0x00018)
#define ISP33_DRC_BILAT4			(ISP3X_DRC_BASE + 0x0001c)
#define ISP33_DRC_GAIN_Y0			(ISP3X_DRC_BASE + 0x00020)
#define ISP33_DRC_GAIN_Y8			(ISP3X_DRC_BASE + 0x00040)
#define ISP33_DRC_COMPRES_Y0			(ISP3X_DRC_BASE + 0x00044)
#define ISP33_DRC_COMPRES_Y8			(ISP3X_DRC_BASE + 0x00064)
#define ISP33_DRC_SCALE_Y0			(ISP3X_DRC_BASE + 0x00068)
#define ISP33_DRC_SCALE_Y8			(ISP3X_DRC_BASE + 0x00088)
#define ISP33_DRC_IIRWG_GAIN			(ISP3X_DRC_BASE + 0x0008c)
#define ISP33_DRC_SFTHD_Y0			(ISP3X_DRC_BASE + 0x00090)
#define ISP33_DRC_SFTHD_Y8			(ISP3X_DRC_BASE + 0x000b0)
...
#define ISP33_LDCH_OUT_HSIZE			(ISP3X_LDCH_BASE + 0x00028)
...
#define ISP33_COMMON3A_BASE			0x00004000
#define ISP33_W3A_CTRL0				(ISP33_COMMON3A_BASE + 0x00000)
#define ISP33_W3A_CTRL1				(ISP33_COMMON3A_BASE + 0x00004)
#define ISP33_W3A_INT_EN			(ISP33_COMMON3A_BASE + 0x00010)
#define ISP33_W3A_INT_STAT			(ISP33_COMMON3A_BASE + 0x00014)
#define ISP33_W3A_INT_MASK			(ISP33_COMMON3A_BASE + 0x00018)
#define ISP33_W3A_AEBIG_ADDR			(ISP33_COMMON3A_BASE + 0x00020)
#define ISP33_W3A_AE0_ADDR			(ISP33_COMMON3A_BASE + 0x00024)
#define ISP33_W3A_AF_ADDR			(ISP33_COMMON3A_BASE + 0x00030)
#define ISP33_W3A_AWB_ADDR			(ISP33_COMMON3A_BASE + 0x00034)
#define ISP33_W3A_PDAF_ADDR			(ISP33_COMMON3A_BASE + 0x00038)
#define ISP33_W3A_AEBIG_ADDR_SHD		(ISP33_COMMON3A_BASE + 0x00040)
#define ISP33_W3A_AE0_ADDR_SHD			(ISP33_COMMON3A_BASE + 0x00044)
#define ISP33_W3A_AF_ADDR_SHD			(ISP33_COMMON3A_BASE + 0x00050)
#define ISP33_W3A_AWB_ADDR_SHD			(ISP33_COMMON3A_BASE + 0x00054)
#define ISP33_W3A_PDAF_ADDR_SHD			(ISP33_COMMON3A_BASE + 0x00058)
#define ISP33_W3A_DBG0				(ISP33_COMMON3A_BASE + 0x000f0)
...
#define ISP33_AIISP_LINECNT_DONE	BIT(18)
...
#define ISP33_SLICE_ST			BIT(0)
#define ISP33_SLICE_EN			BIT(1)
#define ISP33_OUT_LINE(a)		(((a) >> 16) & 0x3fff)
#define ISP33_SLICE_DONE		BIT(31)

#define ISP33_AIISP_RD_LINECNT(x)	((x) >> 16)
#define ISP33_AIISP_WR_LINECNT(x)	((x) & 0xffff)
...
#define ISP3X_DHAZ_STAB_FNUM_MASK	GENMASK(4, 0)

#define ISP3X_DHAZ_IIR_PRE_WET_MASK	GENMASK(27, 24)
...
#define ISP33_ADRC_CMPS_BYP_EN		BIT(2)
...
/* COMMON3A */
#define ISP33_W3A_EN			BIT(0)
#define ISP33_W3A_PDAF_EN		BIT(1)
#define ISP33_W3A_3A_HOLD_DIS		BIT(2)
#define ISP33_W3A_PDAF2DDR_HOLD_DIS	BIT(3)
#define ISP33_W3A_AUTO_CLR_EN		BIT(4)
#define ISP33_W3A_CLK_GATING_DIS	BIT(5)
#define ISP33_W3A_FORCE_UPD		BIT(31)

#define ISP33_W3A_INT_AEBIG		BIT(0)
#define ISP33_W3A_INT_AE0		BIT(1)
#define ISP33_W3A_INT_AF		BIT(4)
#define ISP33_W3A_INI_AWB		BIT(5)
#define ISP33_W3A_INT_PDAF		BIT(6)
#define ISP33_W3A_INT_ERR		BIT(16)

#define ISP33_W3A_INT_ERR_MASK		GENMASK(31, 16)
#define ISP33_W3A_INT_AEBIG_OVF		BIT(16)
#define ISP33_W3A_INT_AE0_OVF		BIT(17)
#define ISP33_W3A_INT_AF_HIIR_OVF	BIT(20)
#define ISP33_W3A_INT_AF_VIIR_OVF	BIT(21)
#define ISP33_W3A_INT_AF_AEHGL_OVF	BIT(22)
#define ISP33_W3A_INT_AWB_OVF		BIT(23)
#define ISP33_W3A_INT_PDAF_OVF		BIT(24)
#define ISP33_W3A_INT_WCFIFO_WR_ERR	BIT(30)
#define ISP33_W3A_INT_WCFIFO_RD_ERR	BIT(31)
